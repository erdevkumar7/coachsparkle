        ...
        <div className="request-form mx-auto shadow-sm">
          <div className="row g-3">
            <div className="col-md-6">
              ...
              <input
                ...
                placeholder="Wellness & Health Coaches"
              />
            </div>
            <div className="col-md-6">
            ...
            <div className="col-md-6">
              <div className="mb-3 position-relative">
                ...
                <div className="form-select-multi" onClick={toggleDropdown}>
                  {selected.length === 0 && (
                    <span className="placeholder">Select language</span>
                  )}
                  {selected.map((lang) => (
                    <span className="pill-tag" key={lang}>
                      {lang}
                      <button type="button" onClick={() => removeTag(lang)}>
                        &times;
                      </button>
                    </span>
                  ))}
          ...
          <div className="form-check mt-4 d-flex align-items-center">
            ...
            <label className="form-check-label" htmlFor="consentCheckbox">
              Yes, please share my request with suitable coaches who can help me
              reach my goals.
            </label>
          </div>
